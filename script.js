...
document.addEventListener("DOMContentLoaded", function () {
    ...
    */
    ...
    max_q = getDataFromCookie("maxQInput") != "" ? parseInt(getDataFromCookie("maxQInput")) : 997;
    ...
    try {
        ...
        data.forEach((question) => {
            ...
            Object.keys(question["answers"]).forEach((key) => {
                ...
                answers.push(`<button class="btn btn-secondary" onclick="checkAnswer(this)">${answer}</button>`);
            });
